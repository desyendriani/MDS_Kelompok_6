...
```{r}
tempat_wisata <- read.csv("C:/Users/Asus/Documents/S2 IPB/Semester 2/Praktikum MDS/Data/tempat_wisata.csv", sep = ";")
```

```{r}
kabupaten_kota <- read.csv("C:/Users/Asus/Documents/S2 IPB/Semester 2/Praktikum MDS/Data/kabupaten_kota.csv", sep = ";")
kecamatan <- read.csv("C:/Users/Asus/Documents/S2 IPB/Semester 2/Praktikum MDS/Data/kecamatan.csv", sep = ";")
kelurahan <- read.csv("C:/Users/Asus/Documents/S2 IPB/Semester 2/Praktikum MDS/Data/kelurahan.csv", sep = ";")
tempat_wisata <- read.csv("C:/Users/Asus/Documents/S2 IPB/Semester 2/Praktikum MDS/Data/tempat_wisata.csv", sep = ";")
detail_wisata <- read.csv("C:/Users/Asus/Documents/S2 IPB/Semester 2/Praktikum MDS/Data/detail_wisata.csv", sep = ";")
detail_kab <- read.csv("C:/Users/Asus/Documents/S2 IPB/Semester 2/Praktikum MDS/Data/detail_kab.csv", sep = ",")
```
...
for (i in 1:nrow(kabupaten_kota)) {
  query <- sprintf(
    "INSERT INTO kabupaten_kota (kode_kabupaten_kota, nama_kabupaten_kota, ibukota, jumlah_penduduk) VALUES ('%s', '%s', '%s', %d)",
...
for (i in 1:nrow(kecamatan)) {
  query <- sprintf(
    "INSERT INTO kecamatan (kode_kecamatan, nama_kecamatan, kode_kabupaten_kota, jumlah_penduduk_kecamatan) VALUES ('%s', '%s', '%s', %d)",
...
for (i in 1:nrow(kelurahan)) {
  query <- sprintf(
    "INSERT INTO kelurahan (kode_kelurahan, nama_kelurahan, kode_kecamatan, jumlah_penduduk_kelurahan) VALUES ('%s', '%s', '%s', %d)",
...
for (i in 67:nrow(tempat_wisata)) {
  query <- sprintf(
    "INSERT INTO tempat_wisata (kode_wisata , tipe_wisata , nama_wisata , kode_kabupaten_kota, kode_kecamatan, kode_kelurahan, deskripsi,harga_tiket, rating, alamat) VALUES ('%s', '%s', '%s','%s', '%s', '%s','%s', '%s' ,%f, '%s')",
...
```{r}
# Masukkan data ke tabel kelurahan secara manual
for (i in 61:nrow(detail_wisata)) {
  query <- sprintf(
...
for (i in 1:nrow(detail_kab)) {
  query <- sprintf(
    "INSERT INTO detail_kab (kode_kabupaten_kota, jumlah_masjid, jumlah_restoran, jumlah_wisatawan, PDRB) VALUES ('%s', %d, %d, %d, %f)",
